	...
	<div class="row d-flex justify-content-arround">
		<div class="col">
			<a href="VotoFormulario" class="btn btn-info my-4 border border-primary"
				style=" padding: 10px 20px; font-size: 40px; border-radius: 10px;">¡Vota
				por un equipo!</a>
		</div>
		<div class="col d-flex justify-content-start" style="width:full">
			<a href="FormularioCrearEquipo.jsp" class="btn btn-info my-4 border border-primary"
			style=" padding: 10px 20px; font-size: 40px; border-radius: 10px;">¡Crea un equipo!</a>
		</div>
